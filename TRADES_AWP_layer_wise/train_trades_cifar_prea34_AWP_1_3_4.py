...
from utils_awp_prea34_1_3_4 import TradesAWP
from utils_rwp import TradesRWP

parser = argparse.ArgumentParser(description='PyTorch CIFAR TRADES Adversarial Training')
parser.add_argument('--arch', type=str, default='PreActResNet34')
...
parser.add_argument('--model-dir', default='./model-cifar-PreActResNet34-AWP-1-3-4',
...
parser.add_argument('--robustWP', default=0, type=int,
...
def test(model, test_loader, criterion, perturb_steps):
    #global best_acc
    model.eval()
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(test_loader):
            ...
            inputs_adv_pgd = perturb_input_pgd(model=model,
                                                       x_natural=inputs,
                                                       target=targets,
                                                       step_size=step_size,
                                                       epsilon=epsilon,
    ...
    return losses.avg, top1.avg, pgd_adv_losses.avg, pgd_adv_top1.avg
...
def main():
    ...
    logger.set_names(['Learning Rate',
                      'Train Loss', 'Train Acc.', 'PGD Adv Train Loss', 'PGD Adv Train Acc.',
                      'Test Loss', 'Test Acc.', 'PGD Adv Test Loss', 'PGD Adv Test Acc.'])
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        print('================================================================')
        train_loss, train_acc, pgd_adv_train_loss, pgd_adv_train_acc = test(model, train_loader, criterion, args.num_steps)
        val_loss, val_acc, pgd_adv_val_loss, pgd_adv_val_acc = test(model, test_loader, criterion, args.num_steps*2)
        print('================================================================')

        logger.append([lr, train_loss, train_acc, pgd_adv_train_loss, pgd_adv_train_acc, val_loss, val_acc, pgd_adv_val_loss, pgd_adv_val_acc])
