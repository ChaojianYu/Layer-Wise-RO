...
from utils import *
from utils_awp_dpn26_1_3_4 import AdvWeightPerturb
...
def get_args():
    ...
    parser.add_argument('--model', default='dpn26')
    ...
    parser.add_argument('--fname', default='cifar_model_dpn26_AWP_1_3_4', type=str)
