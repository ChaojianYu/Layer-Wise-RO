...
from dla import DLA
from utils import *
from utils_awp_Dla_2_3_4 import AdvWeightPerturb
...
def get_args():
    ...
    parser.add_argument('--model', default='dla')
    ...
    parser.add_argument('--fname', default='cifar_model_dla_AWP_2_3_4', type=str)
