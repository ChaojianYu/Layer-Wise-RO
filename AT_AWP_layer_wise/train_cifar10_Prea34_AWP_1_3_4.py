...
from utils import *
from utils_awp_prea34_1_3_4 import AdvWeightPerturb
...
def get_args():
    ...
    parser.add_argument('--model', default='PreActResNet34')
    ...
    parser.add_argument('--fname', default='cifar_model_prea34_AWP_1_3_4', type=str)
...
def main():
    ...
    if args.model == 'PreActResNet18':
        ...
        proxy = PreActResNet34()
        proxy_proxy = PreActResNet34()
    else:
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_batches):
            ...
            if epoch >= args.awp_warmup:
                ...
                if args.robustWP:
                    rwp = rwp_adversary.calc_awp(inputs_adv=X_adv, targets=y, LSC_loss=1.7)
